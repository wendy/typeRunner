var prompt = '<span class="word">var</span> <span class="word">each</span> <span class="word">=</span> <span class="word">function(collection,</span> <span class="word">iterator)</span> <span class="word new-line">{</span>
